...
class Size_PositionApp(App):           #App Class - Allows you to run Kivy
    pass

Size_PositionApp().run()

#! This is the base set up for every Kivy app. 
#! You have to substanciate the Kivy object at the end with the class "Size_PositionApp()" and select the run() method.